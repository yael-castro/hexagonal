...
import (
	"context"
	"github.com/yael-castro/payments/internal/container"
	"github.com/yael-castro/payments/internal/runtime"
	"log"
	"os"
	"os/signal"
	"syscall"
...
func main() {
	...
	go func() {
		log.Printf("Command version '%s' is running", runtime.GitCommit)
		exitCodeCh <- cmd(ctx)
		close(exitCodeCh)
	}()
